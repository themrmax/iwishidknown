...
db.execute("create table today_deaths (surname varchar(200), firstnames varchar(200), source varchar (20))")
with open('/Users/maxflander/iwishidknown/watchlist.txt') as f:
   reader = csv.reader(f)
   for line in reader:
